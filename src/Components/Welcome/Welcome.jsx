...
const Welcome = () => {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-3 w-11/12 mx-auto py-10'>
      <div className=' lg:col-span-2 lg:my-20 space-y-8'>
        <h1 className=' text-4xl font-bold text-center lg:text-left'>Welcome to <span className=' text-basicColor'>Health & Wellness Events</span></h1>
        <p className=' text-justify text-lg lg:w-10/12 text-gray-600'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 lg:w-10/12 gap-4 lg:gap-2 font-bold '>
